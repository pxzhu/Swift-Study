...
/*
 문자열 내부에서 특수문자를 사용하기 싫다면 문자열 앞, 뒤에 #을 붙여주세요
 */
let number351: Int = 100
print(#"특수문자를 사용하지 않을 때도 문자열 보간법을 사용하고 싶다면 이렇게 \#(number351) 해보세요"#)
/*
 특수문자를 사용하지 않을 때도 문자열 보간법을 사용하고 싶다면 이렇게 100 해보세요
 */

// Any
var someVar36: Any = "pxzhu"      // Any로 선언된 변수에는 문자열
someVar36 = 50                    // 정수
someVar36 = 100.1                 // 실수 또는 어떤 타입의 값이라도 할당할 수 있음
